...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-base shadow-sm">
            <div class="container">
                <a class="navbar-brand"  style="color:white; font-size:16pt; font-weight:bold"
                 href="{{ url('/') }}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                              ...
                              <a class="dropdown-item" href="{{ route('seller_login')}}">As Vendor</a>
                            </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">
                                  ...
                                  <a class="dropdown-item" href="{{ route('show_seller_registeration_page') }}">As Vendor</a>
                                </div>
                              </li>
                            @endif
                        @else
